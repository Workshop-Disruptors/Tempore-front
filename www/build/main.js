...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__nouveau_medecin_nouveau_medecin__ = __webpack_require__(103);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__rendez_vous_rendez_vous__ = __webpack_require__(102);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__pages_rendez_vous_rendez_vous__ = __webpack_require__(102);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__pages_nouveau_medecin_nouveau_medecin__ = __webpack_require__(103);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__angular_common_http__ = __webpack_require__(105);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__pages_rendez_vous_rendez_vous__ = __webpack_require__(102);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__pages_nouveau_medecin_nouveau_medecin__ = __webpack_require__(103);
...
var LoginPage = (function () {
    ...
    LoginPage = __decorate([
        ...
        __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* NavController */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* NavController */]) === "function" && _a || Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_4__providers_register_api_register_api__["a" /* RegisterApiProvider */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_4__providers_register_api_register_api__["a" /* RegisterApiProvider */]) === "function" && _b || Object, typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["a" /* AlertController */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["a" /* AlertController */]) === "function" && _c || Object])
    ], LoginPage);
    return LoginPage;
    var _a, _b, _c;
}());
...
var RegisterApiProvider = (function () {
    ...
    RegisterApiProvider.prototype.postDoctor = function (doctorData) {
        ...
        return new Promise(function (resolve, reject) {
            ...
            _this.http.post("http://afternoon-river-25926.herokuapp.com/doctor/register", body, { headers: headers, withCredentials: true })
                .subscribe(function (ans) {
                resolve(ans);
            }, function (err) {
                reject(err);
    ...
    RegisterApiProvider.prototype.loginDoctor = function (doctorLogin) {
        ...
        return new Promise(function (resolve, reject) {
            ...
            _this.http.post("http://afternoon-river-25926.herokuapp.com/doctor/login", body, { headers: headers, withCredentials: true })
                .subscribe(function (ans) {
                resolve(ans);
            }, function (err) {
                reject(err);
    ...
    RegisterApiProvider.prototype.infoDoctor = function () {
        ...
        return new Promise(function (resolve, reject) {
            var headers = new Headers();
            headers.append("Content-Type", "application/json");
            _this.http.get("http://afternoon-river-25926.herokuapp.com/doctor/profile", { headers: headers, withCredentials: true })
                .subscribe(function (ans) {
                resolve(ans);
            }, function (err) {
                reject(err);
    ...
    RegisterApiProvider.prototype.delay = function (newdelay) {
        ...
        return new Promise(function (resolve, reject) {
            ...
            _this.http.post("http://afternoon-river-25926.herokuapp.com/doctor/profile", body, { headers: headers, withCredentials: true })
                .subscribe(function (ans) {
                resolve(ans);
            }, function (err) {
                reject(err);
    ...
    RegisterApiProvider.prototype.logout = function () {
        ...
        return new Promise(function (resolve, reject) {
            var headers = new Headers();
            headers.append("Content-Type", "application/json");
            _this.http.get("http://afternoon-river-25926.herokuapp.com/doctor/logout", { headers: headers, withCredentials: true })
                .subscribe(function (ans) {
                resolve(ans);
            }, function (err) {
                reject(err);
