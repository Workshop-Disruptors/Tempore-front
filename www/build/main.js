...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return NouveauMedecinPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(12);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__login_login__ = __webpack_require__(42);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__medecin_medecin__ = __webpack_require__(29);
...
var NouveauMedecinPage = (function () {
    function NouveauMedecinPage(navCtrl) {
        this.navCtrl = navCtrl;
    }
    NouveauMedecinPage.prototype.goToLogin = function (params) {
        if (!params)
            params = {};
        this.navCtrl.push(__WEBPACK_IMPORTED_MODULE_2__login_login__["a" /* LoginPage */]);
    };
    NouveauMedecinPage.prototype.goToMedecin = function (params) {
        if (!params)
            params = {};
        this.navCtrl.push(__WEBPACK_IMPORTED_MODULE_3__medecin_medecin__["a" /* MedecinPage */]);
    };
    NouveauMedecinPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-nouveau-medecin',template:/*ion-inline-start:"/Users/gael/Documents/GitHub/WorkshopGit/front/src/pages/nouveau-medecin/nouveau-medecin.html"*/`<ion-header>\n  <ion-navbar>\n    <button ion-button menuToggle>\n      <ion-icon name="menu"></ion-icon>\n    </button>\n    <ion-title>\n      Nouveau medecin\n    </ion-title>\n  </ion-navbar>\n</ion-header>\n<ion-content padding id="page6">\n  <form id="nouveauMedecin-form5">\n    <ion-searchbar placeholder="" name="" id="nouveauMedecin-search2"></ion-searchbar>\n    <div class="spacer" style="width:300px;height:60;" id="nouveauMedecin-spacer5"></div>\n    <ion-item id="nouveauMedecin-list-item-container6">\n      <div id="nouveauMedecin-markdown11" class="show-list-numbers-and-dots">\n        <p style="margin-top:0px;color:#000000;">\n          Infos\n        </p>\n      </div>\n    </ion-item>\n    <div class="spacer" style="width:300px;height:60px;" id="nouveauMedecin-spacer6"></div>\n  </form>\n  <button id="nouveauMedecin-button10" ion-button color="positive" block on-click="goToLogin()">\n    Valider\n  </button>\n</ion-content>`/*ion-inline-end:"/Users/gael/Documents/GitHub/WorkshopGit/front/src/pages/nouveau-medecin/nouveau-medecin.html"*/
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* NavController */]])
    ], NouveauMedecinPage);
    return NouveauMedecinPage;
}());

//# sourceMappingURL=nouveau-medecin.js.map
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(12);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__medecin_medecin__ = __webpack_require__(29);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__rendez_vous_rendez_vous__ = __webpack_require__(203);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var TemporePage = (function () {
    ...
    TemporePage.prototype.goToMedecin = function (params) {
        if (!params)
            params = {};
        this.navCtrl.push(__WEBPACK_IMPORTED_MODULE_2__medecin_medecin__["a" /* MedecinPage */]);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(12);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__nouveau_medecin_nouveau_medecin__ = __webpack_require__(102);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__login_login__ = __webpack_require__(42);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__medecin_medecin__ = __webpack_require__(29);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__providers_display_display__ = __webpack_require__(205);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var RendezVousPage = (function () {
    ...
    RendezVousPage.prototype.goToNouveauMedecin = function (params) {
        if (!params)
            params = {};
        this.navCtrl.push(__WEBPACK_IMPORTED_MODULE_2__nouveau_medecin_nouveau_medecin__["a" /* NouveauMedecinPage */]);
    };
    RendezVousPage.prototype.goToLogin = function (params) {
        if (!params)
            params = {};
        this.navCtrl.push(__WEBPACK_IMPORTED_MODULE_3__login_login__["a" /* LoginPage */]);
    };
    RendezVousPage.prototype.goToMedecin = function (params) {
        if (!params)
            params = {};
        this.navCtrl.push(__WEBPACK_IMPORTED_MODULE_4__medecin_medecin__["a" /* MedecinPage */]);
    };
    ...
    RendezVousPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-rendez-vous',template:/*ion-inline-start:"/Users/gael/Documents/GitHub/WorkshopGit/front/src/pages/rendez-vous/rendez-vous.html"*/`<ion-header>\n  <ion-navbar>\n    <button ion-button menuToggle>\n      <ion-icon name="menu"></ion-icon>\n    </button>\n    <ion-title>\n      À l\'heure ?\n    </ion-title>\n  </ion-navbar>\n</ion-header>\n<ion-content padding id="page2">\n<ion-searchbar (ionInput)="getItems($event)"></ion-searchbar>\n  <ion-list>\n    <ion-item *ngFor="let doctor of doctors" >\n      <h2>{{doctor.name}} - {{doctor.city}}</h2>\n      <h3>{{doctor.description}} - {{doctor.tel}}</h3>\n      <p>{{doctor.delay}} min de retard </p>\n     </ion-item>\n  </ion-list>\n</ion-content>`/*ion-inline-end:"/Users/gael/Documents/GitHub/WorkshopGit/front/src/pages/rendez-vous/rendez-vous.html"*/,
            providers: [__WEBPACK_IMPORTED_MODULE_5__providers_display_display__["a" /* DisplayProvider */]]
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* NavController */], __WEBPACK_IMPORTED_MODULE_5__providers_display_display__["a" /* DisplayProvider */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["a" /* AlertController */]])
    ], RendezVousPage);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(12);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__medecin_medecin__ = __webpack_require__(29);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers_register_api_register_api__ = __webpack_require__(52);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var DisplayProvider = (function () {
    ...
    DisplayProvider.prototype.listDoctors = function () {
        ...
        return new Promise(function (resolve, reject) {
            ...
            _this.http.get("http://localhost:3000/doctor/list", { headers: headers, withCredentials: true })
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__pages_tempore_tempore__ = __webpack_require__(103);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__pages_rendez_vous_rendez_vous__ = __webpack_require__(203);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__pages_medecin_medecin__ = __webpack_require__(29);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__pages_login_login__ = __webpack_require__(42);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__pages_nouveau_compte_nouveau_compte__ = __webpack_require__(204);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__pages_mes_informations_mes_informations__ = __webpack_require__(284);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__pages_nouveau_medecin_nouveau_medecin__ = __webpack_require__(102);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__providers_register_api_register_api__ = __webpack_require__(52);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__providers_display_display__ = __webpack_require__(205);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["I" /* NgModule */])({
            declarations: [
                ...
                __WEBPACK_IMPORTED_MODULE_10__pages_nouveau_medecin_nouveau_medecin__["a" /* NouveauMedecinPage */]
            ],
            imports: [
            ...
            providers: [
                ...
                __WEBPACK_IMPORTED_MODULE_14__providers_register_api_register_api__["a" /* RegisterApiProvider */],
                __WEBPACK_IMPORTED_MODULE_15__providers_display_display__["a" /* DisplayProvider */]
            ]
        })
    ], AppModule);
    return AppModule;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__pages_rendez_vous_rendez_vous__ = __webpack_require__(203);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__pages_nouveau_medecin_nouveau_medecin__ = __webpack_require__(102);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__pages_login_login__ = __webpack_require__(42);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__pages_medecin_medecin__ = __webpack_require__(29);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__pages_tempore_tempore__ = __webpack_require__(103);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var MyApp = (function () {
    ...
    MyApp.prototype.goToNouveauMedecin = function (params) {
        if (!params)
            params = {};
        this.navCtrl.setRoot(__WEBPACK_IMPORTED_MODULE_5__pages_nouveau_medecin_nouveau_medecin__["a" /* NouveauMedecinPage */]);
    };
    ...
    MyApp = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({template:/*ion-inline-start:"/Users/gael/Documents/GitHub/WorkshopGit/front/src/app/app.html"*/`<ion-menu [content]="mainContent">\n  <ion-header>\n    <ion-toolbar>\n      <ion-title>\n        Menu\n      </ion-title>\n    </ion-toolbar>\n  </ion-header>\n  <ion-content id="side-menu21">\n    <ion-list id="menu-list1">\n      <ion-item color="none" menuClose="" on-click="goToTempore()" id="menu-list-item1">\n        Accueil\n      </ion-item>\n      <ion-item color="none" menuClose="" on-click="goToRendezVous()" id="menu-list-item2">\n        À l\'heure ?\n      </ion-item>\n      <ion-item color="none" menuClose="" on-click="goToMedecin()" id="menu-list-item3">\n        Médecin\n      </ion-item>\n    </ion-list>\n  </ion-content>\n</ion-menu>\n\n<ion-nav #mainContent [root]="rootPage"></ion-nav>`/*ion-inline-end:"/Users/gael/Documents/GitHub/WorkshopGit/front/src/app/app.html"*/
        }),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__tempore_tempore__ = __webpack_require__(103);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__login_login__ = __webpack_require__(42);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_ionic_angular__ = __webpack_require__(12);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_register_api_register_api__ = __webpack_require__(52);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var MedecinPage = (function () {
    ...
    MedecinPage.prototype.goToTempore = function (params) {
        if (!params)
            params = {};
        this.navCtrl.push(__WEBPACK_IMPORTED_MODULE_1__tempore_tempore__["a" /* TemporePage */]);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(12);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__medecin_medecin__ = __webpack_require__(29);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__nouveau_compte_nouveau_compte__ = __webpack_require__(204);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_register_api_register_api__ = __webpack_require__(52);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
...
var RegisterApiProvider = (function () {
    ...
    RegisterApiProvider.prototype.postDoctor = function (doctorData) {
        ...
        return new Promise(function (resolve, reject) {
            ...
            _this.http.post("http://localhost:3000/doctor/register", body, { headers: headers, withCredentials: true })
                .subscribe(function (ans) {
                resolve(ans);
            }, function (err) {
                reject(err);
    ...
    RegisterApiProvider.prototype.loginDoctor = function (doctorLogin) {
        ...
        return new Promise(function (resolve, reject) {
            ...
            _this.http.post("http://localhost:3000/doctor/login", body, { headers: headers, withCredentials: true })
                .subscribe(function (ans) {
                resolve(ans);
            }, function (err) {
                reject(err);
    ...
    RegisterApiProvider.prototype.infoDoctor = function () {
        ...
        return new Promise(function (resolve, reject) {
            var headers = new Headers();
            headers.append("Content-Type", "application/json");
            _this.http.get("http://localhost:3000/doctor/profile", { headers: headers, withCredentials: true })
                .subscribe(function (ans) {
                resolve(ans);
            }, function (err) {
                reject(err);
    ...
    RegisterApiProvider.prototype.delay = function (newdelay) {
        ...
        return new Promise(function (resolve, reject) {
            ...
            _this.http.post("http://localhost:3000/doctor/profile", body, { headers: headers, withCredentials: true })
                .subscribe(function (ans) {
                resolve(ans);
            }, function (err) {
                reject(err);
    ...
    RegisterApiProvider.prototype.logout = function () {
        ...
        return new Promise(function (resolve, reject) {
            var headers = new Headers();
            headers.append("Content-Type", "application/json");
            _this.http.get("http://localhost:3000/doctor/logout", { headers: headers, withCredentials: true })
                .subscribe(function (ans) {
                resolve(ans);
            }, function (err) {
                reject(err);
